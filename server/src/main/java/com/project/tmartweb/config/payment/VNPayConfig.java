package com.project.tmartweb.config.payment;
...
public class VNPayConfig {
    ...
    public static String vnpTmnCode = "ULAA9CUF";
    public static String vnpHashSecret = "6F7D5FD1NS2MWYZHRENBSM6BB4SC1ODH";
    ...
    public static String hmacSHA512(final String key, final String data) {
        ...
        try {
            ...
            log.error(ex.getMessage());
            throw new RuntimeException("Error while generate hmac : " + ex.getMessage());
        }
    }
